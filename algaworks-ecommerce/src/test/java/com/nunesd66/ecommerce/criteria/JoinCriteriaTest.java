...
public class JoinCriteriaTest extends EntityManagerTest {
    ...
    public void usarJoinFetch() {
        ...
        root.fetch("cliente");
        //Join<Pedido, Cliente> joinCliente = (Join<Pedido, Cliente>) root.<Pedido, Cliente>fetch("itens");
    ...
    public void fazerLeftOuterJoin() {
        ...
        CriteriaQuery<Pedido> criteriaQuery = criteriaBuilder.createQuery(Pedido.class);
        Root<Pedido> root = criteriaQuery.from(Pedido.class);
        Join<Pedido, ItemPedido> joinPagamento = root.join("pagamento", JoinType.LEFT);
    ...
    public void fazerJoinComOn() {
        ...
        CriteriaQuery<Pedido> criteriaQuery = criteriaBuilder.createQuery(Pedido.class);
        Root<Pedido> root = criteriaQuery.from(Pedido.class);
        Join<Pedido, ItemPedido> joinPagamento = root.join("pagamento");
