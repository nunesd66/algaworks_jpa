...
public class GroupByCriteriaTest extends EntityManagerTest {
    ...
    public void condicionarAgrupamentoComHaving() {
        ...
        criteriaQuery.having(
                criteriaBuilder.greaterThan(
                        ...
                        new BigDecimal(700).doubleValue()
                )
        );
        ...
        resultado.forEach(arr -> System.out.println(
    ...
    public void agruparResultadoComFuncoes() {
        ...
        resultado.forEach(arr -> System.out.println("Ano/Mês: " + arr[0] + ", Sum: " + arr[1]));
    }

    @Test
    public void agruparResultado03Exercicio() {
        // Total de vendas por cliente
        // jpql = select c.nome, sum(ip.precoProduto) from ItemPedido ip join ip.pedido p join p.cliente c group by c.id
        ...
        criteriaQuery.groupBy(
                joinPedidoCliente.get(Cliente_.id)
        );
