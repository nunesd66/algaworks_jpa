...
public class OperacoesEmLoteTest extends EntityManagerTest {
    ...
    private final int LIMITE_INSERCOES = 10;

    @Test
    public void removerEmLote() throws IOException {
        inserirEmLotes();
    ...
    @Test
    public void atualizarEmLotes() throws IOException {
        inserirEmLotes();

        entityManager.getTransaction().begin();

        String jpql = "update Produto p set p.preco = p.preco + CAST(p.preco * 0.1 AS java.math.BigDecimal) " +
    ...
    @Test
    public void inserirEmLotes() throws IOException {
