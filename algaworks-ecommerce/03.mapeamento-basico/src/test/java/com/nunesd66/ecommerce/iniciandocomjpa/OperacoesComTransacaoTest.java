...
public class OperacoesComTransacaoTest extends EntityManagerTest {
    ...
    public void impedirOperacaoComBancoDeDados() {
        ...
        entityManager.detach(produto); // não gerencia mais o objeto

        entityManager.getTransaction().begin();
        produto.setNome("Kindle Paperwhite 2ª Geração"); // não funciona com gerenciamento
    ...
    public void mostrarDiferencaPersistMerge() {
        /*
            PERSIST:
            - sua única funcionalidade é salvar dados, não serve para atualizar;
            - o valor do objeto persistido é gerenciado, onde qualquer alteração futura no objeto é atualizdo antes do
            commit.
         */
        ...
        Produto produtoPersisteVerificacao = entityManager.find(Produto.class, produtoPersiste.getId());
        assertNotNull(produtoPersisteVerificacao);

        /*
            MERGE:
            - consegue atualizar e salvar;
            - o objeto em merge tem uma cópia gerenciada, onde só é possível alterar obtendo uma referência da cópia do
            objeto do merge.
         */
